#!/usr/bin/env python3
"""Antigravity Deep Distill batch runner."""
...
SCRIPT = _BIN_DIR / "antigravity-session-distill.py"
mod = load_adapter(SCRIPT, "agy_sd")
...
def main() -> int:
    parser = build_arg_parser("Antigravity deep distill batch runner")
